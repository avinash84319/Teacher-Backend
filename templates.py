...
template_question_dictionary={
    "mcq": "Create {no_of_questions} questions with four options and correct answers and {difficulty} and also {marks}",
    "subjective": "Create a {no_of_questions} subjective question with the correct answers and {difficulty} and also {marks}",
    "true_false": "Create {no_of_questions} true/false questions, also give the correct answer in only true or false and {difficulty} and also {marks}",
    "fill_in_the_blank": """Create {no_of_questions} fill-in-the-blanks questions where one word will be missing , instead of missing word add underscores and remove the word from question, with the correct answers will be that missing word, and {difficulty} and also {marks} examples :The protagonist of the novel "1984" is ___ (Winston/O'Brien).
    ...
    "match_the_following": "Create {no_of_questions} match the following questions with the correct answers and {difficulty} and also {marks}",
    "one_word": "Create {no_of_questions} one-word questions with the correct answers and {difficulty} and also {marks}",
}
